...
export type FeatureCard = {
  title: string;
  summary: string;
  media?: MediaItem[];     // 0개면 미디어 영역 숨김, 1개면 단일, 2개 이상이면 슬라이드
  points?: string[];       // 상세/포인트 (네 카드 내부 스크롤 영역)
  notionHref?: string;     // 상세 문서 링크
};
...
export type ProjectData = {
  ...
  description?: string;
  tags?: string[];
  // ✅ 지금은 “히어로 옆 영상/미디어”를 빼기로 했으니 primaryMedia는 optional로만 둠
    ...
    },
    {
      ...
      cards: [
        ...
        // Mission (3컷 이미지)
        {
          ...
          media: [
            { type: "image", src: "/media/projects/oz-rewrite/mission_01.png", alt: "탭 전환" },
            { type: "image", src: "/media/projects/oz-rewrite/mission_02.png", alt: "완료 상태" },
            { type: "image", src: "/media/projects/oz-rewrite/mission_03.png", alt: "보상 수령" },
          ],
          points: [
        ...
        // Inventory (4컷 이미지)
        {
          ...
          media: [
            { type: "image", src: "/media/projects/oz-rewrite/inv_01.png", alt: "인벤토리 메인" },
            { type: "image", src: "/media/projects/oz-rewrite/inv_02.png", alt: "바로가기/획득 경로" },
            { type: "image", src: "/media/projects/oz-rewrite/inv_03.png", alt: "확률 띠지" },
            { type: "image", src: "/media/projects/oz-rewrite/inv_04.png", alt: "기간/만료 안내" },
          ],
          points: [
        ...
        // Event UI (재활용 구조 / 4컷)
        {
          ...
          media: [
            { type: "image", src: "/media/projects/oz-rewrite/eventui_01.png", alt: "이벤트 메인1" },
            { type: "image", src: "/media/projects/oz-rewrite/eventui_02.png", alt: "이벤트 메인2" },
            { type: "image", src: "/media/projects/oz-rewrite/eventui_03.png", alt: "상점 재활용" },
            { type: "image", src: "/media/projects/oz-rewrite/eventui_04.png", alt: "미션 재활용" },
          ],
          points: [
